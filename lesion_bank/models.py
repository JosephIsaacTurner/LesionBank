...
class PracticeImages(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True)
    timestamp = models.DateTimeField(auto_now_add=True)
    file_name = models.FileField(upload_to=PathAndRename('practice_masks'), blank=True, null=True)
    true_file_name = models.FileField(upload_to=PathAndRename('practice_masks'), blank=True, null=True)
    file_size = models.IntegerField()
