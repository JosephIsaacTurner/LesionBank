...
def getNiftiFromCloud(cloud_filepath):
    return storage.get_file_from_cloud(cloud_filepath)

def compress_nii_image(nii_img):
    return storage.compress_nii_image(nii_img)
...
if __name__== '__main__':
    nifti1 = getNiftiFromCloud("sensitivity_maps/Hypersomnia_sensitivity_parametric.nii.gz")
    nifti2 = getNiftiFromCloud("sensitivity_maps/Insomnia_sensitivity_parametric.nii.gz")
